  ...
  >
    <div class="md-toolbar-row md-collapse-lateral">
      <div class="md-toolbar-section-start">
        <h3 class="md-title">
          <router-link :to="{ name: 'index' }" style="color:#ffffff, "
            ><img src="@/assets/img/logo1.png" style="width : 100px"
          /></router-link>
        </h3>
      </div>
          ...
          <div class="md-collapse-wrapper">
            ...
            <md-list>
              ...
              <li class="md-list-item">
                <main-navbar-member></main-navbar-member>
              </li>
            </md-list>
          </div>
        </div>
...
import MainNavbarMember from "@/layout/MainNavbarMember.vue";
